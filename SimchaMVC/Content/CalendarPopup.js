...
function CP_tmpReturnFunction(y,m,d) { 
	if (window.CP_targetInput!=null) {
		...
		if (document.getElementById('fromdate').value != 'mm/dd/yyyy' && document.getElementById('todate').value != 'mm/dd/yyyy' ) 
		{
		setcookies('fromdate',document.getElementById('fromdate').value);
		setcookies('todate',document.getElementById('todate').value);
		}
		}
		else if(document.getElementById('details')) {fillslots()}
		// END INSERTED CODE 
